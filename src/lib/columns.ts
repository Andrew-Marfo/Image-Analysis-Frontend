...
/**
 * The 13 IMDB columns, in the exact order required for submission output.
...
export const IMDB_COLUMNS: ColumnDef[] = [
  ...
  { key: 'VARIANT', header: 'VARIANT', label: 'Variant', example: 'ORIGINAL', expected: false },
  { key: 'TYPE', header: 'TYPE', label: 'Type', example: 'MARGARINE', expected: true },
